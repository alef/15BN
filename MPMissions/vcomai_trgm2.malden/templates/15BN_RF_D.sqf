...
for "_i" from 1 to 5 do {this addItemToBackpack "rhs_mag_mk84";};
...
comment "Add weapons";
this addWeapon "rhs_weap_m4a1_carryhandle_grip3";
this addPrimaryWeaponItem "rhsusf_acc_nt4_black";
this addPrimaryWeaponItem "ACE_acc_pointer_green";
this addPrimaryWeaponItem "rhsusf_acc_ACOG_RMR_pip";
